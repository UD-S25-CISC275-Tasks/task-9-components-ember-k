...
export function isCorrect(question: Question, answer: string): boolean {
    let formattedQ: string = question.expected.trim().toLocaleLowerCase();
    let formattedA: string = answer.trim().toLowerCase();
    return formattedQ === formattedA;
}
